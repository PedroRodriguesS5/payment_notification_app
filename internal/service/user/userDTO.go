...
type UserRegisterDTO struct {
	...
	Password     string `json:"password" validate:"password_strength" errormgs:"A senha é obrigatória e deve ter ao menos 8 caracteres, incluindo uma letra maiúscula, uma minúscula, um número e um caractere especial"`
	...
	UserDocument string `json:"user_document" validate:"required,validate_document" errormgs:"Documento inválido"`
